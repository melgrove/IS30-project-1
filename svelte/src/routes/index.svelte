...
<div class="h-full w-full bg-blue-100 pt-20">
    ...
    <div class="flex flex-col w-11/12 sm:w-4/5 items-center bg-white shadow mt-10 pt-20 pb-20 mb-20">
        ...
        <div class="body w-5/6 sm:w-3/5 mt-8">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TThrough these past two decades, one impactful design change to Google Search is the widgets. They provide users with information immediately, almost halving the time required for users to find their results. Widgets include weather forecast, sports scores, and the calculator. The rise of widgets indicates how Google Search has become considerably more personalized. Google collects data about each user to produce better recommendations and results. As O’Reilly predicted, “companies that succeed will create applications that learn from their users” (PP). Thus, O’Reilly’s 3rd principle of Web 2.0 “Data is the Next Intel Inside” sums up Google’s pathway to success. Instead of serving the same information to everyone, Google leverages machine learning models to recommend improved results. If a marine biologist searches for “dolphins”, academic articles and news about dolphins appear, whereas a Miami Dolphins fan sees a sports widget with the team’s schedule and scores. This personalization is a continuation of internet trends that are described by Burnett and Marshall. While the use of data specifically is heralded as a creation of Web 2.0 in O’Reilly, the driving force behind it, the desire for personalization, is a factor of internet culture that has existed for far longer than the Web 2.0 era.    
        </div>
        <figure class = "items-center">
        ...
        <div class="body w-5/6 sm:w-3/5 mt-8">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The algorithm that started in a garage in northern California has matured into a search engine with many features to enhance the user experience. 
        </div>
